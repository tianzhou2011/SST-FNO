...
class FNOblock(nn.Module):
    ...
    '''
    def __init__(self,hidden_features,modes_x,modes_y,modes_z,n_layers=4,factor=4,n_ff_layers=2,dropout=0,kernel_size=1):
...
class FTSNO_w_gn_bottom_base_Model(nn.Module):
    """
    ...
    def __init__(self, n_layers, d_model,total_length,input_length,enc_in,enc_out,modes_x,modes_y,modes_z,factor,n_ff_layers,x_dim,y_dim,z_dim,pre,pre_dim,pad_x,pad_y,pad_z,dropout):
        super(FTSNO_w_gn_bottom_base_Model, self).__init__()        
        ...
        self.prefactor = FNOblock_ST(hidden_features=pre_dim*self.enc_in,n_layers=n_layers,modes_x=modes_x,modes_y=modes_y,modes_z=modes_z)
        self.preblock = FNOblock(hidden_features=self.in_dim,n_layers=n_layers,modes_x=modes_x,modes_y=modes_y,modes_z=modes_z)
        self.midblock_down = FNOblock(hidden_features=2*self.in_dim,n_layers=n_layers,modes_x=int(modes_x/2),modes_y=int(modes_y/2),modes_z=modes_z)
        self.endblock_down = FNOblock(hidden_features=4*self.in_dim,n_layers=n_layers,modes_x=int(modes_x/4),modes_y=int(modes_y/4),modes_z=modes_z)
        self.endblock_up = FNOblock(hidden_features=2*self.in_dim,n_layers=n_layers,modes_x=int(modes_x/2),modes_y=int(modes_y/2),modes_z=modes_z)
        self.midblock_up = FNOblock(hidden_features=self.in_dim,n_layers=n_layers,modes_x=int(modes_x/1),modes_y=int(modes_y/1),modes_z=modes_z)
        self.posterfactor = FNOblock_ST(hidden_features=self.in_dim,n_layers=n_layers,modes_x=modes_x,modes_y=modes_y,modes_z=modes_z)
